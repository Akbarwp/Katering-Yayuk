...
@section('container')
    <section id="homeMatriks" class="bg-light pb-36">
        <div class="container font-sarabun">
            <div class="w-full pt-16 px-6">
                ...
                <div class="w-2/3 mx-auto pt-16 px-6 text-dark">
                    ...
                    <a href="/dashboard/perbandingan" class="btn btn-accent mt-5">Kembali</a>
                </div>
            </div>
        </div>
    </section>
