            ...
            <div class="w-full pt-16 px-6">
                <div class="mx-auto text-center">
                    <h1 class="mb-5 text-dark text-5xl font-bold">
                        Daftar Sub Kriteria
                        <a href="subkriteria/tambahh" class="btn btn-circle btn-sm btn-success ml-2 hover:bg-opacity-80">
                        ...
                        <table class="table table-zebra w-2/3 mx-auto text-center justify-center text-light">
                            ...
                            <tbody>
                                ...
                                @foreach ($subKriteria as $sk)
                                    <tr>
                                        <th class="bg-primary">{{ $sk->id }}</th>
                                        <td class="bg-primary">{{ $sk->nama }}</td>
                                        <td class="bg-primary">
                                            <a href="subkriteria/ubahh/{{ $sk->id }}"
                                                class="btn btn-warning mr-2 hover:bg-opacity-80">Ubah</a>
                                            <a href="subkriteria/hapuss/{{ $sk->id }}"
